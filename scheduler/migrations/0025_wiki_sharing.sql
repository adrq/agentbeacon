-- 0025: Share tag membership and project slugs.
-- ADD COLUMN + CREATE INDEX only: no table rebuild on this table.
-- projects.slug is filled by the startup backfill, which only touches NULLs.
